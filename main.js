...
var Form = /*#__PURE__*/function () {
  ...
  _createClass(Form, [{
    ...
    value: function onFormSubmit(e) {
      e.preventDefault();
      var isImageTitle = e.target.imageTitle.validity.valid;
      var isImageUrl = e.target.imageUrl.validity.valid;
      if (!isImageTitle) {
      ...
      e.target.dispatchEvent(new Event('formSubmit', {
        bubbles: true
      }));
      this.element.reset();
    }
...
;// CONCATENATED MODULE: ./src/js/components/Pictures.js
function Pictures_typeof(o) { "@babel/helpers - typeof"; return Pictures_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, Pictures_typeof(o); }
...
function Pictures_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function Pictures_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, Pictures_toPropertyKey(descriptor.key), descriptor); } }
function Pictures_createClass(Constructor, protoProps, staticProps) { if (protoProps) Pictures_defineProperties(Constructor.prototype, protoProps); if (staticProps) Pictures_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function Pictures_toPropertyKey(t) { var i = Pictures_toPrimitive(t, "string"); return "symbol" == Pictures_typeof(i) ? i : String(i); }
function Pictures_toPrimitive(t, r) { if ("object" != Pictures_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != Pictures_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
var Pictures = /*#__PURE__*/function () {
  function Pictures() {
    Pictures_classCallCheck(this, Pictures);
  ...
  Pictures_createClass(Pictures, [{
    ...
    key: "onFormEnter",
    value: function onFormEnter(e) {
      var imageTitle = e.target.imageTitle.value;
    ...
    value: function onFileInputChange(e) {
      ...
      files.forEach(function (file) {
        ...
        reader.onload = function (ev) {
          _this.checkImageSrc(ev.target.result, file.name);
        };
      });
      e.target.value = '';
    }
    ...
    value: function createInputFile() {
      ...
      this.inputFile.addEventListener('dragover', function (e) {
        e.preventDefault();
        e.target.classList.add('dragover');
        _this2.overlay.textContent = '+';
      });
      this.inputFile.addEventListener('dragleave', function (e) {
        e.preventDefault();
        e.target.classList.remove('dragover');
        _this2.overlay.textContent = 'нажмите или перетащите картинки сюда';
      });
      this.inputFile.addEventListener('drop', function (e) {
        e.target.classList.remove('dragover');
        _this2.overlay.textContent = 'нажмите или перетащите картинки сюда';
      });
    ...
    key: "onBtnCloseClick",
    value: function onBtnCloseClick(e) {
      var itemToDelete = e.target.closest('.image-item');
      itemToDelete.remove();
      this.imageEl = null;
    }
  }, {
    ...
    key: "checkImageSrc",
    value: function checkImageSrc(src, title) {
    ...
    key: "createPicture",
    value: function createPicture(el) {
